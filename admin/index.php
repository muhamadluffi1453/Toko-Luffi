...
//koneksi ke database
$koneksi = new mysqli("localhost","root","","tokoluffi"); 

//skrip pengamanan login
...
<head>
    ...
    <title>Selamat Datang di Toko Luffi</title>
	<!-- BOOTSTRAP STYLES-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">TOKO LUFFI</a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="foto_produk/img/luffi" class="user-image img-responsive"/>
					</li>
